        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Asar Dagyara (Treasure Hunt)</h2>
                </div>
                <div class="card-body">
                    <form action="server/process_grp_registration.php" method="POST">
                        ...
                        <div class="form-row">
                            <div class="name">To Pay: <br><h2>Rs 400/-</h2></div>
                            <div class="value">
                                <div class="input-group">
                                    <img src="images\Asar Dagyara_qrcode.png" width=300px height=400px><br>
