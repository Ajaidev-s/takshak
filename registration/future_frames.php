        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Future Frames (Digital Art)</h2>
                </div>
                <div class="card-body">
                    <form action="server/process_indi_reg.php" method="POST">
                        ...
                        <div class="form-row">
                            <div class="name">To Pay: <br><h2>Rs 50/-</h2></div>
                            <div class="value">
                                <div class="input-group">
                                    <img src="images\Future_frames_qrcode.jpg" width=300px height=400px><br>
