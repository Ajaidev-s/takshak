        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Valorant Vortex (Gaming)</h2>
                </div>
                <div class="card-body">
                    <form action="server/process_grp_registration.php" method="POST">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" placeholder="enter your team name" name="teamname" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="name">Team Captain Name</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" placeholder="enter your team captain name" name="teamcaptain" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" placeholder="enter the name" name="member2" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" placeholder="enter the name" name="member3" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" placeholder="enter the name" name="member4" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" placeholder="enter the name" name="member5" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row m-b-55">
                            <div class="name">Alternate Number</div>
                            <div class="value">
                                <div class="row row-refine">
                                    <div class="col-9">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" required pattern="\d{10}" title="Phone number must be 10 digits" placeholder="enter alternate number (any of team member's)" name="altphone">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="name">To Pay: <br><h2>Rs 300/-</h2></div>
                            <div class="value">
                                <div class="input-group">
                                    <img src="images\VALORANT VORTEX_qrcode.jpg" width=300px height=400px><br>
