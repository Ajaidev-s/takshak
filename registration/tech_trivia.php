        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Tech Trivia (Quiz)</h2>
                </div>
                <div class="card-body">
                    <form action="server/process_grp_registration.php" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" placeholder="enter the name" name="teamcaptain" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <img src="images\Tech-Trivia_qrcode.jpg" width=300px height=400px><br>
